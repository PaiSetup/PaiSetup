...
if __name__ == "__main__":
    ...
    path_args.add_argument("--xresources_theme_path",          type=Path, default=home/".config/PaiSetup" / wm / "XresourcesTheme",  help="Path to Xresources file storing wallpaper-specific theme.")
